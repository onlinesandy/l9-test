                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ Vite::asset('resources/assets/images/user.jpg') }}" alt="Header Avatar">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="icons-crypto.html" class="nav-link"> <span
                                                data-key="t-crypto-svg">Crypto SVG</span> <span
                                                class="badge badge-pill bg-danger" data-key="t-new">New</span></a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card card-height-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="users-by-country" data-colors='["--kyn-light"]'
                                        ...
                                        <div class="card-body p-0">
                                            <div>
                                                <div id="countries_charts"
                                                    data-colors='["--kyn-info", "--kyn-info", "--kyn-info", "--kyn-info", "--kyn-danger", "--kyn-info", "--kyn-info", "--kyn-info", "--kyn-info", "--kyn-info"]'
                                ...
                                <div class="card-body p-0 pb-2">
                                    <div>
                                        <div id="audiences_metrics_charts"
                                            data-colors='["--kyn-success", "--kyn-gray-300"]' class="apex-charts"
                                            dir="ltr"></div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                                ...
                                <div class="card-body p-0">
                                    <div>
                                        <div id="audiences-sessions-country-charts"
                                            data-colors='["--kyn-success", "--kyn-info"]' class="apex-charts"
                                            dir="ltr"> </div>
                                    </div>
                                </div><!-- end cardbody -->
                            </div><!-- end card -->
                            ...
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="user_device_pie_charts"
                                        data-colors='["--kyn-primary", "--kyn-warning", "--kyn-info"]'
                                        class="apex-charts" dir="ltr"></div>
