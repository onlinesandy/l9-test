...
!(function () {
    var r = "{{ Vite::asset('resources/assets/images/user.jpg') }}",
        n = "{{ Vite::asset('resources/assets/images/user.jpg') }}",
        o = !1;
    function s() {
    ...
    function u(e, t, s, n, a) {
        ...
        if (null != t)
            ...
            for (
                r += '<div class="message-img mb-0">', i = 0;
                i < s.length;
                i++
            )
                r +=
        ...
        (e = e),
            (t = function (e, t) {
                ...
                null !== e
                    ...
                    (l = document.querySelector("#close_toggle")),
    ...
    e("chat-users-list.json", function (e, t) {
        ...
        p();
    var v = document.querySelector("#chatinput-form"),
                ...
                a.querySelectorAll(".copy-message").forEach(function (e) {
                    e.addEventListener("click", function () {
                        a.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute(
                            ...
                            (isText =
                                a.childNodes[1].children[1].firstElementChild
