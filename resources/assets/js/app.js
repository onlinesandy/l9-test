!(function () {
        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                    document.getElementById("lang-option-us").src)
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                    document.getElementById("lang-option-spain").src)
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                    document.getElementById("lang-option-germany").src)
                : "in" == e
                    ? (document.getElementById("header-lang-img").src =
                        document.getElementById("lang-option-india").src)
                : "fr" == e &&
                  (document.getElementById("header-lang-img").src =
                  document.getElementById("lang-option-french").src),
    ...
    function v() {
        "vertical" == document.documentElement.getAttribute("data-layout") &&
            ...
            "horizontal" ==
                document.documentElement.getAttribute("data-layout") && k();
    }
    function S() {
        feather.replace();
